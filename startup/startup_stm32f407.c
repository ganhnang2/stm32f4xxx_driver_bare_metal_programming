...
/* Định nghĩa một số vector ngắt cơ bản */
...
void Reset_Handler(void) {
    /* Copy vùng .data từ Flash xuống RAM */
	...
	/* Khởi tạo thư viện C chuẩn (newlib). 
	 * Bắt buộc phải có để Semihosting hoặc các hàm printf/malloc hoạt động đúng */
	__libc_init_array();
